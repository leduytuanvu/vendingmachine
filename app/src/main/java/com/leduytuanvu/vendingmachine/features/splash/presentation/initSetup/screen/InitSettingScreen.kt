...
import com.leduytuanvu.vendingmachine.features.splash.presentation.initSetup.viewModel.InitSetupViewModel
...
fun InitSetupContent(
    ...
    var inputVendingMachineCode by remember { mutableStateOf("AVF000123") }
